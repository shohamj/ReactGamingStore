...
export default class CreateGroup extends React.Component {
  ...
  onSubmit(e) {
    ...
    if (!isValid) {
      this.props.chatStore.errors = {
        ...
        this.props.chatStore.submitRegisterForm(true).then(
        data => {
        ...
        () => {
          this.props.chatStore.registerLoading = false;
          this.props.chatStore.registerName = "";
          this.props.chatStore.registerImage = null;
          this.refs.registerImage.value = ''
          this.props.chatStore.groupRequestsChanged();          
          confirmAlert({
            title: 'Request Created',
            message: 'Your request for creating a new group has been created. It is now pending for manual confirmation by a manager.',
            buttons: [
              {
                label: 'Ok',
                onClick: undefined
  ...
  render() {
    ...
    return (
      <div>
        <PageBanner title="Create Chat Group" />
        <div className="">
          <form
