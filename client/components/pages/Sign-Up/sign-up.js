...
class SignUp extends React.Component {
        ...
        onSubmit(e) {
            ...
            if (!isValid) {
                this.props.signupStore.Errors = errors;
            } else
                this.props.signupStore.submitForm()
                .then(
                    (data) => { this.props.signupStore.Errors = data }, //Fail
                    (data) => {
                        this.props.signinStore.Message = "Signed up successfuly! You can now log in!";
        ...
        render() {
            const { Username, Email, Password, ConfirmPassword, Errors } = this.props.signupStore;
            return (<div className="pad-bot">
            ...
            <p className="mtext-107 cl2 txt-center p-b-30 pad-top">
              Or
              <Link to="/sign-in" className="mtext-107 cl2 txt-center p-b-30">
